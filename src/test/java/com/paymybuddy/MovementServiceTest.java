...
public class MovementServiceTest {
    ...
    @Test
    public void movementNullWhenNoAmount() throws Exception {
    ...
    @Test
    public void movementKONotEnoughBalance() throws Exception {
    ...
    public void movementCreditOk() throws Exception {
        ...
        assertNotNull(movementRepository.findById(movement.getId()).get());
    }
